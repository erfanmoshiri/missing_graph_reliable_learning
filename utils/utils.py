...
def build_optimizer(args, params):
    ...
    scheduler = optim.lr_scheduler.ReduceLROnPlateau(
        ...
        mode='min',
        factor=0.1,
        patience=5,  # Reduce patience to make adjustments more frequent
        threshold=1e-4,
        min_lr=1e-6,
        cooldown=5  # Allow a cooldown period to recover and improve
    )
    ...
    #     else:
    #         return max(0.1, (total_epochs - epoch) / (total_epochs - warmup_epochs))  # Decay after warm-up
    #
